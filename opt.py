...
def config_parser(cmd=None):
    ...
    parser.add_argument('--model_name', type=str, default='TensorVMSplit',
                        choices=['TensorVMSplit', 'TensorVMSplitVQ','TensorCP'])
    parser.add_argument("--use_cosine_sim", type=int, default=0)
    parser.add_argument("--codebook_size", type=int, default=4096)
    parser.add_argument("--codebook_dim", type=int, default=0)
    parser.add_argument("--autotask", action='store_true', default=False)
    parser.add_argument("--debug", action='store_true', default=False)
    parser.add_argument("--pct_mid", type=float, default=0.999)
    parser.add_argument("--pct_high", type=float, default=0.7)
    parser.add_argument("--split_or_union", type=int, default=0, help='0: split, 1: union')
    parser.add_argument("--lr_scale", type=float, default=0.25)
    parser.add_argument("--vq_iters", type=int, default=10000)
    parser.add_argument("--vq_up_interval", type=int, default=10)
